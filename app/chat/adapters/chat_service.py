    ...
    def get_fairytale(self, prompt, systemPromt=None):
        completion = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "system", "content": 'Генерируй сказки в таком формате:Название сказки: ... \n\n'
                                              '---\n\n'
                                              'Время чтения: ... \n\n'
                                              'Урок: ... '
                                              ' ... сказка ...\n\n'
                ...
                {"role": "system", "content": systemPromt},
                {"role": "user", "content": prompt}
                # {"role": "system", "content": "В начале сказки напиши название сказки, сколько минут уходит на чтение и урок от данной сказки"}
